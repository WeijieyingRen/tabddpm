...
if __name__ == '__main__':
    ...
    raw_config = lib.load_config('/home/huangyuqing/tab-ddpm-main/exp/higgs-small/ddpm_cb_best/config.toml')
    T_dict = deepcopy(raw_config['eval']['T'])
    
    train_catboost(
        parent_dir='/home/huangyuqing/treevae-main/models/experiments/higgs-small/20240106-182306_e2316/',
        real_data_path='/home/huangyuqing/tab-ddpm-main/data/higgs-small/',
        eval_type='real',
        T_dict=T_dict,
        seed=10,
        change_val=False
