...
def main():
    ...
    config = {}
    config['parent_dir'] = '/home/huangyuqing/treevae-main/models/experiments/wilt/20240106-153430_d29e3/'
    config['real_data_path'] = '/home/huangyuqing/tab-ddpm-main/data/wilt/'
